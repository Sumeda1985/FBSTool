...
ui <-
    dashboardPage(
        dashboardHeader(titleWidth = 600,
                        title = span(
        ...
        dashboardSidebar(
            sidebarMenu(
                ...
                menuItem("Production", tabName = "production",
                         icon = icon("fa-solid fa-tractor")),
                menuItem("Trade", tabName = "Trade",
                         icon = icon("fa-thin fa-globe")),
                menuItem("Stock", tabName = "Stock",
                         icon = icon("th")),
                menuItem("Loss", tabName = "Loss",
                         icon = icon("fa-regular fa-trash")),
                menuItem("Feed", tabName = "Feed",
                         icon = icon("fa-thin fa-hippo")),
                menuItem("Seed", tabName = "Seed",
                         icon = icon("fa-thin fa-seedling")),
                menuItem("Industrial Non-Food Use", tabName = "Industry",
                         icon = icon("fa-thin fa-industry")),
                menuItem("Food Availability", tabName = "Food",
                         icon = icon("th")),
                menuItem("SUA",
                         icon = icon("book"),
                         menuSubItem("SUA Unbalanced",
                                     tabName = "sua_unbalanced",
                                     icon = icon("book")),
                         menuSubItem("SUA Balanced", tabName = "sua_balanced",
                ...
                menuItem("Fish, Seafood", tabName = "fish",
                         icon = icon("fa-thin fa-fish")),
                menuItem("FBS",
                         tabName = "fbs_tab", icon = icon("th-list"),
                         menuSubItem("FBS", tabName = "fbs",
                                     icon = icon("th-list")),
                         menuSubItem("FBS Report", tabName = "fbs_report",
                                     icon = icon("th-list"))
                         ),
                menuItem("Nutrients",
                         tabName = "nutrient_tab", icon = icon("th-list"),
                         menuSubItem("Nutrients by FBS food group",
                                     tabName = "total_des",
                                     icon = icon("th-list")),
                         menuSubItem("Nutrients by GIFT food group",
                                     tabName = "gift", icon = icon("th-list"))
                         ),
                ...
                menuItem("Indicators", tabName = "indicators",
                         icon = icon("th-list")),
                menuItem("Reference Tables", tabName = "reference",
                         icon = icon("th-list"))
            )
        ),
        dashboardBody(
            ...
            tabItems(
                tabItem(
                    ...
                    fluidRow(
                        box(
                            ...
                            textInput(inputId = "fromyear", label = "From",
                                      width = "400px"),
                            textInput(inputId = "endyear", label = "To",
                                      width = "400px"),
                            br(),
                            column(
                                3,
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = "Select the Country", width = 12,
                            status = "primary",
                            solidHeader = TRUE, collapsible = TRUE,
                            selectInput(inputId = "countrym49",
                                        label = "Country", width = "400px",
                ...
                tabItem(
                    tabName = "reference",
                    box(
                        title = "Flags", width = 12, status = "primary",
                        collapsed = TRUE,
                        solidHeader = TRUE, collapsible = TRUE,
                    ...
                    box(
                        title = "SUA Commodities", width = 12,
                    ...
                    box(
                        title = "FBS Commodities", width = 12,
                        status = "primary", collapsed = TRUE,
                        solidHeader = TRUE, collapsible = TRUE,
                        ## tags$style(".skin-blue .sidebar a { color: #444; }"), # higlting tabs)
                    ...
                    box(
                        title = "Trade Commodities", width = 12,
                        status = "primary", collapsed = TRUE,
                        solidHeader = TRUE, collapsible = TRUE,
                        ## tags$style(".skin-blue .sidebar a { color: #444; }"), # higlting tabs)
                    ...
                    box(
                        title = "Elements", width = 12, status = "primary",
                        collapsed = TRUE,
                        solidHeader = TRUE, collapsible = TRUE,
                        ## tags$style(".skin-blue .sidebar a { color: #444; }"), # higlting tabs)
                    ...
                    box(
                        title = "FBS Group", width = 12, status = "primary",
                        collapsed = TRUE,
                        solidHeader = TRUE, collapsible = TRUE,
                        ## tags$style(".skin-blue .sidebar a { color: #444; }"), # higlting tabs)
                    ...
                    box(
                        title = "Nutrient Elements", width = 12,
                        status = "primary", collapsed = TRUE,
                        solidHeader = TRUE, collapsible = TRUE,
                        ## tags$style(".skin-blue .sidebar a { color: #444; }"), # higlting tabs)
                ...
                tabItem(
                    ...
                    ## ),
                    box(
                        title = "FBS", width = 12, height = 100,
                        status = "primary", collapsed = TRUE,
                        solidHeader = TRUE, collapsible = TRUE,
                        downloadButton("download_fbs_balanced", "Download",
                                       class = "butt1"),
                        div(
                            style = "display:inline-block",
                            dropdownButton(
                                label = "FBS Report", # fullwidth=TRUE,
                                textInput(inputId = "fbs_report_yr",
                                          label = "Year : ", value = "",
                                          width = "250px"),
                                actionGroupButtons(
                                    inputIds = c("fbs_report_button"),
                                    labels = list(tags$span(icon("plus"),
                                                            "Get FBS Report")),
                                ...
                                tooltip = tooltipOptions(title = "FBS Report",
                                                         placement = "top")
                            )
                        ),
                        div(
                            ...
                            actionGroupButtons(
                                ...
                                labels = list(tags$span(icon("magic"),
                                                        "Total DES & Nutrients")),
                ...
                tabItem(
                    ...
                    ## ),
                    box(
                        title = "FBS Report", width = 12, height = 50,
                        status = "primary", collapsed = TRUE,
                        solidHeader = TRUE, collapsible = TRUE,
                        br(), br(),
                        ## tags$style(".skin-blue .sidebar a { color: #444; }"), # higlting tabs)
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = "SUA Unbalanced", width = 12,
                            status = "primary", collapsed = TRUE,
                            solidHeader = TRUE, collapsible = TRUE,
                            tags$style(".skin-blue .sidebar a { color: #444; }"), # higlting tabs
                            br(),
                            downloadButton("download_sua_unbalanced",
                    ...
                    fluidRow(
                        box(
                            title = "Commodity Tree", background = "aqua",
                            ...
                            div(
                                ...
                                actionGroupButtons(
                                    ...
                                    labels = list(
                                        tags$span(icon("save"),
                                                  "Save Modifications to the tree")),
                                    status = "warning", direction = "vertical"
                                )
                            ),
                            ## div(style="display:inline-block",
                            ...
                            br(),
                            br(),
                            DT::dataTableOutput("commodity_tree",
                                                height = "auto")
                        )
                    )
                ),
                tabItem(
                    tabName = "sua_balanced",
                    fluidRow(
                        box(
                            title = "SUA Balanced", width = 12, height = 100,
                            status = "primary",
                            solidHeader = TRUE, collapsible = TRUE,
                            fluidRow(
                                column(width = 4,
                                       downloadButton("download_sua_balanced",
                                                      "Download",
                                                      class = "butt1")),
                                ## column(width = 2,
                                ## actionButton("standardizeAggrigate",
                                ## "Standardize & Aggregate", align = 'center', styleclass = "success", block =T))
                                div(
                                    style = "display:inline-block",
                                    actionGroupButtons(
                                        inputIds = c("fbs_balanced_button"),
                                        labels = list(
                                            tags$span(icon("magic"),
                                                      "FBS Standardization")),
                                        status = "info", direction = "vertical"
                                    )
                                    ## downloadButton("downloadSUA_Aggregate", "Download Time Series", class= "butt1")
                                ...
                                br(),
                                br(),
                                checkboxInput("checkbox", "Visualize Nutrients",
                                              value = FALSE)
                            ),
                            br(), br(), br(),
                    ...
                    fluidRow(
                        box(
                            title = "Nutrient Factors", background = "aqua",
                            width = 12, collapsed = TRUE,
                            solidHeader = TRUE, collapsible = TRUE,
                            br(),
                            div(
                                ...
                                actionGroupButtons(
                                    ...
                                    labels = list(
                                        tags$span(icon("save"),
                                                  "Save Modifications to nutrient factors")),
                                    status = "warning", direction = "vertical"
                                )
                            ),
                            column(width = 2,
                                   downloadButton("download_nutri_table",
                                                  "Download", class = "butt1")),
                            br(), br(), br(),
                            DT::dataTableOutput("nutrient_factors",
                                                height = "auto")
                        )
                    )
                ),
                tabItem(
                    tabName = "total_des",
                    box(
                        title = "Nutrients by FBS food group", width = 12, status = "primary",
                        ...
                        br(),
                        h4("*Nutrient Values are in capita/day",
                    ...
                    tabBox(
                        ...
                        tabPanel("Data self-sufficiency ratio",
                                 ...
                                 fluidRow(
                                     column(
                                         width = 4,
                                         downloadButton("download_table_ssr",
                                                        "Download",
                                                        class = "butt1")
                                     )
                                 ),
                        ...
                        tabPanel("Data import dependency ratio",
                                 ...
                                 fluidRow(
                                     column(
                                         width = 4,
                                         downloadButton("download_table_idr",
                                                        "Download",
                                                        class = "butt1")
                                     )
                                 ),
                                 br(), br(), br(),
                                 DT::dataTableOutput("table_idr",
                                                     height = "auto")
                                 )
                    )
                ),
                tabItem(
                    tabName = "gift",
                    box(
                        title = "Nutrients by GIFT food group", width = 12,
                        height = 100, status = "primary",
                        solidHeader = TRUE, collapsible = TRUE,
                        fluidRow(
                            column(width = 4,
                                   downloadButton("download_gift",
                                                  "Download", class = "butt1"))
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            ...
                            div(
                                ...
                                actionGroupButtons(
                                    ...
                                    labels = list(tags$span(icon("trash-alt"),
                                                            "Delete Commodity")
                                                  ),
                            ...
                            div(
                                style = "display:inline-block",
                                dropdownButton(
                                    label = "Upload/Download", ## fullwidth=TRUE,
                                    actionGroupButtons(
                                        inputIds = c("uploadCropModal"),
                                        labels = list(
                                            tags$span(icon("plus"),
                                                      "Upload Crop Data (Normalized)")),
                                        status = "primary", direction = "vertical"
                                    ), br(),
                                    fileInput("fileCropdenormalized",
                        ...
                        box(
                            title = a("Livestock", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=65"), width = 12, status = "primary",
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = a("Stock Change", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=70"), width = 12, status = "primary", br(),
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = a("Fish, Seafood", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=70"), width = 12, status = "primary", br(),
                            solidHeader = TRUE, collapsible = TRUE,
                            div(
                                style = "display:inline-block",
                                actionGroupButtons(
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = "Loss Ratios", width = 12, status = "primary",
                            ...
                            div(
                                style = "display:inline-block",
                                actionGroupButtons(
                                    inputIds = c("loss_imputation_ratio"),
                    ...
                    fluidRow(
                        box(
                            title = a("Loss", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=91"), width = 12, status = "primary",
                            solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
                            br(),
                            br(), br(),
                            div(
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = "Feed Ratios", width = 12, status = "primary",
                            solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
                            br(),
                            div(
                                style = "display:inline-block",
                            ...
                            div(
                                style = "display:inline-block",
                                actionGroupButtons(
                                    inputIds = c("feed_imputation_ratio"),
                    ...
                    fluidRow(
                        box(
                            title = a("Feed", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=79"), width = 12, status = "primary",
                            solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
                            br(),
                            div(
                                style = "display:inline-block",
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = "Seed Rates", width = 12, status = "primary",
                            solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
                            br(),
                            div(
                                style = "display:inline-block",
                            ...
                            div(
                                style = "display:inline-block",
                                actionGroupButtons(
                                    inputIds = c("seed_imputation_ratio"),
                    ...
                    fluidRow(
                        box(
                            title = a("Seed", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=83"), width = 12, status = "primary",
                            solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
                            br(),
                            div(
                                style = "display:inline-block",
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = a("Industrial Non-Food Use", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=89"), width = 12, status = "primary",
                            solidHeader = TRUE, collapsible = TRUE,
                            br(),
                            div(
                                style = "display:inline-block",
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = "GDP per Capita", width = 12, status = "primary", collapsed = TRUE,
                            solidHeader = TRUE, collapsible = TRUE,
                            br(),
                            div(
                                style = "display:inline-block",
                    ...
                    fluidRow(
                        box(
                            title = "Population", width = 12, status = "primary", collapsed = TRUE,
                            solidHeader = TRUE, collapsible = TRUE,
                            br(),
                            div(
                                style = "display:inline-block",
                    ...
                    fluidRow(
                        box(
                            title = "Food Classification", status = "primary",
                            width = 12, collapsed = TRUE,
                            solidHeader = TRUE, collapsible = TRUE,
                            br(),
                            div(
                    ...
                    fluidRow(
                        box(
                            title = a("Food", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=73"), width = 12, status = "primary", collapsed = TRUE,
                            solidHeader = TRUE, collapsible = TRUE,
                            br(),
                            div(
                                style = "display:inline-block",
                ...
                tabItem(
                    ...
                    fluidRow(
                        box(
                            title = a("Imports", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=65"), width = 12, status = "primary", br(),
                            solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
                            div(
                                style = "display:inline-block",
                                div(
                        ...
                        box(
                            title = a("Exports", style = "font-size: 100%;color: white;", href = "FBSGuidelines.pdf##page=68"), width = 12, status = "primary", br(),
                            solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
                            div(
                                style = "display:inline-block",
                                div(
