  ...
  dashboardPage(
    ...
    dashboardSidebar(
      sidebarMenu(
        ...
        menuItem("Industrial Non-Food Use",
          tabName = "Industry",
          icon = icon("fa-thin fa-industry")
        ),
        menuItem("Food Availability",
          tabName = "Food",
          icon = icon("th")
        ),
        menuItem("SUA",
        ...
        tabItem(
          ...
          fluidRow(
            box(
              ...
              textInput(
                inputId = "fromyear", label = "From",
                width = "400px"
              ),
              textInput(
                inputId = "endyear", label = "To",
                width = "400px"
              ),
              br(),
              column(
          ...
          box(
            ...
            div(
              ...
              dropdownButton(
                ...
                textInput(
                  inputId = "fbs_report_yr",
                  label = "Year : ", value = "",
                  width = "250px"
                ),
                actionGroupButtons(
                  inputIds = c("fbs_report_button"),
                  labels = list(tags$span(
                    icon("plus"),
                    "Get FBS Report"
                  )),
